...
var App = function () {
     ...
     **/
        ...
        var handlePortletTools = function () {
            ...
            jQuery('body').on('click', '.portlet .tools a.loading', function (e) {
                e.preventDefault();
                var el = jQuery(this).parents(".portlet").find(".portlet-body");
                App.blockUI(el);
                window.setTimeout(function () {
                    App.unblockUI(el);
                }, 1000);
        ...
        return {
            ...
            blockUI: function (el, centerY) {
                var el = jQuery(el);
                el.block({
                    message: '<img src="./tools/jquery/plugin/image/ajax-loading.gif" align="">',
